...
function (context) {
  ...
  while (!context.reader.isPeekEOF() && context.reader.peek() !== "\n") {
    ...
    if (next !== "'") ident += next;else isNowdoc = true;
  }

  // Read until "\n{ident};"
  while (!context.reader.isPeekEOF() && !context.reader.match("\n" + ident + ";")) {
...
var namedIdentRules = exports.namedIdentRules = {
  custom: [function (context) {
    ...
    if (!prevToken || prevToken.name !== "keyword" || prevToken.value !== "new") return false;
  ...
  function (context) {
    ...
    if (!nextToken || nextToken.name !== "punctuation" || nextToken.value !== ";" && nextToken.value !== ",") return false;
    ...
    while (walker.hasPrev()) {
      ...
      if (token.name === "keyword" && (token.value === "new" || token.value === "instanceof")) return true;
  ...
  [{ token: "ident" }, util.whitespace, { token: "keyword", values: ["extends", "implements"] }, util.whitespace], [{ token: "keyword", values: ["class", "interface", "abstract", "final"] }, util.whitespace]],
