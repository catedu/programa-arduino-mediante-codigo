...
var name = exports.name = "httpd"; // sunlight-x: Intelligent Syntax Highlighting, Modernized
...
function () {
  var words = util.createHashMap(["AuthnProviderAlias", "Directory", "DirectoryMatch", "Files", "FilesMatch", "IfDefine", "IfModule", "IfVersion", "Limit", "LimitExcept", "Location", "LocationMatch", "ProxyMatch", "Proxy", "VirtualHost",
...
function (context) {
  ...
  var prevToken = util.getPreviousNonWsToken(tokens, context.count());
